  ...
  const paragraphStyle = {
    ...
    return (
      <div style={aboutMeStyle}>
        ...
        As a full stack developer, I've delved deep into the dynamic realms of front and back-end development. 
